"""Shared design system helpers and CSS for the SJ Planner UI."""
...
STATUS_PALETTE = {
    "not_started": ("#8B5CF6", "rgba(139,92,246,0.12)"),
    "in_progress": ("#06B6D4", "rgba(6,182,212,0.12)"),
    "blocked": ("#EF4444", "rgba(239,68,68,0.12)"),
    "done": ("#10B981", "rgba(16,185,129,0.12)"),
    "conflict": ("#F59E0B", "rgba(245,158,11,0.12)"),
}
...
def metric_card_html(label: str, value: str, icon: str = "", color: str = COLORS["text"]) -> str:
    """Return a custom metric card HTML."""
    return (
        f'<div style="background:{COLORS["surface"]};border:1px solid {COLORS["border"]};'
        f'border-radius:12px;padding:20px;text-align:left;transition:all 0.15s ease;">'
        f'<div style="font-size:12px;font-weight:700;color:{COLORS["text_secondary"]};'
...
def connection_pill(name: str, connected: bool) -> str:
    ...
    return (
        f'<span style="display:inline-flex;align-items:center;gap:4px;'
        f'font-size:11px;font-weight:600;color:{color};background:{color}12;'
